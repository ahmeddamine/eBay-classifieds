...
export const listings: Listing[] = [
  ...
  {
    id: "l4",
    title: "Nintendo Switch OLED + 2 games",
    price: 280,
    city: "Berlin",
    postedAt: "3d ago",
    ...
    sellerType: "private",
    ships: true,
    seller: { id: "u4", name: "Jasmin L.", memberSince: "2022", listingCount: 5 },
    description: "Console in great condition, includes dock and charger.",
    attributes: [
      { label: "Model", value: "OLED" },
      { label: "Storage", value: "64 GB" },
      { label: "Accessories", value: "Dock + Charger" }
    ]
  }
];
...
export const messages: Message[] = [
  { id: "m1", conversationId: "conv1", sender: "them", text: "Hi, is this still available?", sentAt: "12:33" },
  { id: "m2", conversationId: "conv1", sender: "me", text: "Yes, it is available. Could pick up tomorrow.", sentAt: "12:37" },
  { id: "m3", conversationId: "conv1", sender: "them", text: "Sure, pickup near Mitte works for me.", sentAt: "12:41" }
];
